...
namespace Concrete\Package\KatalysisProAi\Controller\Element\Searches\Header;
...
class Search extends ElementController
{
    ...
    public function view()
    {
        ...
        if (isset($this->headerSearchAction)) {
            ...
            $this->set('headerSearchAction', $this->app->make('url')->to('/dashboard/katalysis_pro_ai/searches'));
        }
