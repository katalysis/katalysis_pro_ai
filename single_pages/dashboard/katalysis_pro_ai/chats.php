...
use KatalysisProAi\Search\Chats\Result\Column;
use KatalysisProAi\Search\Chats\Result\Item;
use KatalysisProAi\Search\Chats\Result\ItemColumn;
use KatalysisProAi\Search\Chats\Result\Result;
use KatalysisProAi\Search\Chats\Result\Menu;
use KatalysisProAi\ChatsMenu;
use KatalysisProAi\Search\Chats\Menu\MenuFactory;
    ...
    (function ($) {
        $(function () {
            ...
            $('#ccm-search-results-table').on('click', 'a[data-id]', function () {
                window.location.href = '<?=rtrim(URL::to('/dashboard/katalysis_pro_ai/chats', 'view_chat'), '/')?>/' + $(this).attr('data-id');
                return false;
            });
